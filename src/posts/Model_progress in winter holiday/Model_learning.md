...
1. 常微分方程模型：用于模拟蔗糖和IPTG对细胞生长和裂解的影响，通过精确预测细胞行为，优化RNA开关在细胞内的表现。

2. 深度学习模型：是项目的亮点，采用**Transformer架构**，能够基于大数据和已有的实验结果设计和优化RNA开关。该模型不仅可以预测RNA序列的二级结构，还能生成高效的RNA开关序列，并优化其功能性，如提高ON/OFF比、增强稳定性和响应速度。
